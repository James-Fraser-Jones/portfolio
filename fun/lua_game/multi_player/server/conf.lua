function love.conf(t)
    ...
    t.window.title = "Tron"         -- The window title (string)
    ...
    t.window.x = 824                    -- The x-coordinate of the window's position in the specified display (number)
    t.window.y = 252                    -- The y-coordinate of the window's position in the specified display (number)
